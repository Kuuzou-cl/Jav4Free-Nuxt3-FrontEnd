            ...
            <div class="row">
                <div class="col-lg-12">
                    <video class="video-jav-player" id="jav_player">
                        <source :src="videoJav.Video.video" title='480p' type="video/mp4" />
                    </video>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-lg-12">
                    ...
                    <button v-for="idol in videoJav.Idols" :key="idol.id" class="btn btn-dark btn-sm mx-1">{{ idol.name }}</button>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-lg-12">
                    <h3 class="title">Categories</h3>
                    <button v-for="category in videoJav.Categories" :key="category.id" class="btn btn-dark btn-sm mx-1">{{ category.name }}</button>
                </div>
            </div>
        </div>
        <div class="row my-2 py-1">
